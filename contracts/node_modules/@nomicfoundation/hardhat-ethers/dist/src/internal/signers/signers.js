...
export class HardhatEthersSigner {
    ...
    static async create(provider, networkName, networkConfig, address) {
        ...
        return new HardhatEthersSigner(address, provider, signerAccounts, networkConfig.ethers.waitForTransactionReceipt);
    }
    constructor(address, provider, signerAccounts, waitForTransactionReceipt) {
    ...
    connect(provider) {
        return new HardhatEthersSigner(this.address, provider, this.#signerAccounts, this.#waitForTransactionReceipt);
    }
    ...
    async sendTransaction(tx) {
        ...
        const transactionResponse = await new Promise((resolve) => {
