...
export declare const ERRORS: {
    readonly CORE: {
        readonly GENERAL: {
            ...
            readonly GLOBAL_OPTION_HIDDEN_NOT_SUPPORTED: {
                readonly number: 23;
                readonly messageTemplate: "Global option \"{globalOption}\" from plugin \"{plugin}\" cannot be hidden";
                readonly websiteTitle: "Global option cannot be hidden";
                readonly websiteDescription: "A global option was defined as hidden, but global options cannot be hidden.";
            };
            readonly INVALID_RESOLVED_CONFIG: {
                readonly number: 24;
                readonly messageTemplate: "Your configuration is invalid once resolved:\n{errors}\n";
                readonly websiteTitle: "Invalid resolved config";
                readonly websiteDescription: "The configuration you provided is seemingly valid, but once resolved it contains errors. Please check the documentation to learn how to configure Hardhat correctly.";
            };
            readonly TEMPLATE_NOT_FOUND_WITH_LIST_OF_OPTIONS: {
                readonly number: 25;
                readonly messageTemplate: "Template \"{template}\" not found.\n\nThe available templates are:\n{availableTemplates}";
                readonly websiteTitle: "Template not found";
                readonly websiteDescription: "The template you provided is not found. Please check the documentation to learn which templates are available.";
            };
            readonly NON_INTERACTIVE_INIT_WOULD_OVERWRITE_FILES: {
                readonly number: 26;
                readonly messageTemplate: "The following files already exist in the current working directory, preventing the initialization of a new Hardhat project:\n{files}\n\nRemove them or move them to a different place and try again.";
                readonly websiteTitle: "Non-interactive init failed due to existing files";
                readonly websiteDescription: "The non-interactive project initialization refuses to overwrite existing files. Remove the conflicting files and retry.";
            };
            readonly NATIVE_BINDING_LOAD_FAILED: {
                readonly number: 27;
                readonly messageTemplate: "Hardhat couldn't load the native binding for {parentPackage}.\n\nMissing platform package: {missingPackage}\n\nThis is usually caused by a known npm bug with optional dependencies (https://github.com/npm/cli/issues/4828), fixed in npm 11.3.0. Node.js 22 bundles npm 10, which doesn't include the fix.\n\nTo fix it, update npm and reinstall your dependencies:\n\n  npm install --global npm@latest\n  rm -rf node_modules package-lock.json\n  npm install\n\nIf that command fails with EBADENGINE, update Node.js to its latest patch release first (or to a newer major), then retry.";
                readonly websiteTitle: "Native binding failed to load";
                readonly websiteDescription: "Hardhat depends on packages that ship prebuilt native binaries, one per platform, declared as optional dependencies. The binary for your platform is missing from your installation.\n\nThis is usually caused by a known npm bug with optional dependencies (https://github.com/npm/cli/issues/4828), which npm fixed in version 11.3.0. Node.js 22 bundles npm 10, which never received the backport, so it can write a lockfile that omits the platform packages.\n\nUpdating npm to 11.3.0 or later and regenerating the lockfile fixes it. Note that the npm fix is not retroactive: an already-affected lockfile has to be regenerated at least once. If updating npm fails with an EBADENGINE error, update Node.js to a newer version first, then retry.";
            };
        };
        readonly INTERNAL: {
        ...
        readonly HOOKS: {
            ...
            readonly FAILED_TO_LOAD_HOOK_HANDLER_FACTORY: {
                readonly number: 302;
                readonly messageTemplate: "Plugin \"{pluginId}\" hook factory for \"{hookCategoryName}\" threw an error while being loaded.";
                readonly websiteTitle: "Plugin hook factory failed during loading";
                readonly websiteDescription: "The loading of a plugin's hook factory failed while being imported";
            };
            readonly FAILED_TO_RUN_HOOK_HANDLER_FACTORY: {
                readonly number: 303;
                readonly messageTemplate: "Plugin \"{pluginId}\" hook factory for \"{hookCategoryName}\" threw an error while being run.\n\nThis is probably a bug in the plugin. Please report it to the plugin author if it keeps happening.";
                readonly websiteTitle: "Plugin hook factory failed during evaluation";
                readonly websiteDescription: "A plugin threw an error while one of its HookHandlerFactories was being run.\n\nThis is probably a bug in the plugin. Please report it to the plugin author if it keeps happening.";
            };
        };
        readonly TASK_DEFINITIONS: {
            ...
            readonly INLINE_ACTION_CANNOT_BE_USED_IN_PLUGINS: {
                readonly number: 417;
                readonly messageTemplate: "The task \"{task}\" defines an \"inlineAction\", which is not allowed in plugins.";
                readonly websiteTitle: "Inline action not allowed in plugins";
                readonly websiteDescription: "Plugins are not allowed to use inline actions for tasks.\n\nPlease define the action in a separate file and reference it.";
            };
            readonly ACTION_ALREADY_SET: {
                readonly number: 418;
                readonly messageTemplate: "The action for task \"{task}\" has already been set. You can only call \"setAction\" or \"setInlineAction\" once per task definition.";
                readonly websiteTitle: "Task action already set";
                readonly websiteDescription: "A task definition can only have one action. You cannot call \"setAction\" or \"setInlineAction\" more than once on the same task builder.\n\nPlease remove the duplicate call.";
            };
            readonly ACTION_AND_INLINE_ACTION_SET: {
                readonly number: 419;
                readonly messageTemplate: "Invalid task definition for task \"{task}\": both \"action\" and \"inlineAction\" are set.";
                readonly websiteTitle: "Task defines both action and inline action";
                readonly websiteDescription: "A task definition cannot have both an \"action\" and an \"inlineAction\". Use one or the other.\n\nPlease remove one of the two action definitions.";
            };
        };
        readonly ARGUMENTS: {
            readonly INVALID_VALUE_FOR_TYPE: {
            ...
            readonly NO_HIDDEN_OPTION_CLI: {
                readonly number: 512;
                readonly messageTemplate: "The option \"{option}\" is hidden and cannot be used from the CLI.";
                readonly websiteTitle: "Hidden options cannot be used from the CLI";
                readonly websiteDescription: "You are trying to use a hidden option from the CLI, which is not allowed.";
            };
            readonly CANNOT_COMBINE_TEMPLATE_AND_TEMPLATES: {
                readonly number: 513;
                readonly messageTemplate: "The options \"--template\" and \"--templates\" cannot be used together. Use \"--init --template <name>\" to initialize a project with a specific template, or \"--init --templates\" to list the available templates.";
                readonly websiteTitle: "The options \"--template\" and \"--templates\" cannot be used together";
                readonly websiteDescription: "The options \"--template\" and \"--templates\" cannot be used together.\n\nUse \"--init --template <name>\" to initialize a project with a specific template, or \"--init --templates\" to list the available templates.";
            };
            readonly MUTUALLY_EXCLUSIVE_OPTIONS: {
                readonly number: 514;
                readonly messageTemplate: "The options \"--{optionA}\" and \"--{optionB}\" cannot be used together";
                readonly websiteTitle: "Mutually exclusive options";
                readonly websiteDescription: "You are trying to use two options that cannot be used together.\n\nPlease double check your arguments.";
            };
            readonly INVALID_VALUE: {
                readonly number: 515;
                readonly messageTemplate: "Invalid value \"{value}\" for argument \"{name}\": {reason}";
                readonly websiteTitle: "Invalid argument value";
                readonly websiteDescription: "One of the arguments you provided has an invalid value.\n\nPlease double check your arguments.";
            };
        };
        readonly BUILTIN_TASKS: {
            ...
            readonly INVALID_FILE_PATH: {
                readonly number: 601;
                readonly messageTemplate: "The path \"{path}\" is a directory. A file path was expected.";
                readonly websiteTitle: "Invalid file path";
                readonly websiteDescription: "A file path was expected, but a directory was provided.\n\nPlease specify a valid file path.";
            };
            readonly FLATTEN_CYCLIC_DEPENDENCY: {
                readonly number: 602;
                readonly messageTemplate: "Hardhat flatten doesn't support cyclic dependencies.\n\nThe following files form a cycle:\n{cycle}";
                readonly websiteTitle: "Hardhat flatten doesn't support cyclic dependencies";
                readonly websiteDescription: "Hardhat `flatten` works by producing a topological order of the dependency graph and concatenating the files in that order. A graph with cycles has no topological order, so the algorithm can't be applied.\n\nIf you need to flatten your project, refactor your Solidity sources to remove the cycle. Cyclic imports are usually avoidable, and removing them tends to make code easier to reason about.";
            };
        };
        readonly NETWORK: {
            readonly INVALID_URL: {
            ...
            readonly PROVIDER_CLOSED: {
                ...
                readonly websiteDescription: "The provider you are trying to use has been closed. Please create a new one using hre.network.create() and try again.";
            };
            ...
            readonly CREATE_SERVER_UNSUPPORTED_NETWORK_TYPE: {
                readonly number: 724;
                readonly messageTemplate: "Cannot create a server for network \"{networkName}\" because it has type \"{networkType}\". Only \"edr-simulated\" networks are supported.";
                readonly websiteTitle: "Unsupported network type for createServer";
                readonly websiteDescription: "The createServer method only supports 'edr-simulated' networks. HTTP networks cannot be used to create a local JSON-RPC server.";
            };
        };
        readonly SOLIDITY_TESTS: {
            ...
            readonly INVALID_SNAPSHOT_FORMAT: {
                readonly number: 803;
                readonly messageTemplate: "Invalid format in snapshot file {file} at line {line}. Expected format: {expectedFormat}.";
                readonly websiteTitle: "Invalid snapshot format";
                readonly websiteDescription: "The snapshot file contains a line with an invalid format.";
            };
            readonly SNAPSHOT_READ_ERROR: {
                readonly number: 804;
                readonly messageTemplate: "Error reading snapshot file at {snapshotsPath}: {error}";
                readonly websiteTitle: "Error reading snapshot file";
                readonly websiteDescription: "There was an error reading the snapshot file.";
            };
            readonly SNAPSHOT_WRITE_ERROR: {
                readonly number: 805;
                readonly messageTemplate: "Error writing snapshot file at {snapshotsPath}: {error}";
                readonly websiteTitle: "Error writing snapshot file";
                readonly websiteDescription: "There was an error writing the snapshot file.";
            };
            readonly MUTUALLY_EXCLUSIVE_SNAPSHOT_FLAGS: {
                readonly number: 806;
                readonly messageTemplate: "The flags --snapshot and --snapshot-check are mutually exclusive.";
                readonly websiteTitle: "Mutually exclusive snapshot flags";
                readonly websiteDescription: "The flags --snapshot and --snapshot-check are mutually exclusive. Please provide only one of them.";
            };
            readonly INLINE_CONFIG_INVALID_KEY: {
                readonly number: 807;
                readonly messageTemplate: "Invalid inline config key \"{key}\" in {functionFqn}. Valid keys are: {validKeys}";
                readonly websiteTitle: "Invalid inline config key";
                readonly websiteDescription: "An unrecognized key was used in an inline config comment.";
            };
            readonly INLINE_CONFIG_DUPLICATE_KEY: {
                readonly number: 808;
                readonly messageTemplate: "Duplicate inline config key \"{key}\" in {functionFqn}";
                readonly websiteTitle: "Duplicate inline config key";
                readonly websiteDescription: "The same configuration key was specified more than once for the same test function.";
            };
            readonly INLINE_CONFIG_INVALID_VALUE: {
                readonly number: 809;
                readonly messageTemplate: "Invalid value \"{value}\" for inline config key \"{key}\" in {functionFqn}. Expected a {expectedType}.";
                readonly websiteTitle: "Invalid inline config value";
                readonly websiteDescription: "The value provided for an inline config key could not be parsed as the expected type.";
            };
            readonly INLINE_CONFIG_UNSUPPORTED_PROFILE: {
                readonly number: 810;
                readonly messageTemplate: "Unsupported profile \"{profile}\" in {functionFqn}. Only the \"default\" profile (or no profile) is supported.";
                readonly websiteTitle: "Unsupported profile";
                readonly websiteDescription: "An inline config comment used a non-default profile, which is not supported by Hardhat.";
            };
            readonly INLINE_CONFIG_INVALID_SYNTAX: {
                readonly number: 811;
                readonly messageTemplate: "Malformed inline config in {functionFqn}. Expected \"key = value\" but found \"{line}\".";
                readonly websiteTitle: "Invalid inline config syntax";
                readonly websiteDescription: "An inline config comment was found but its syntax could not be parsed.";
            };
            readonly INLINE_CONFIG_UNRESOLVED_SELECTOR: {
                readonly number: 812;
                readonly messageTemplate: "Inline config found in {functionFqn}, but no matching function selector was found. Only public or external functions can have inline configuration.";
                readonly websiteTitle: "Unresolved function selector for inline config";
                readonly websiteDescription: "An inline config comment was found on a function that does not have a function selector. This usually means the function is internal or private, and therefore cannot be run as a test.";
            };
            readonly INLINE_CONFIG_INVALID_KEY_FOR_TEST_TYPE: {
                readonly number: 813;
                readonly messageTemplate: "The inline config key \"{key}\" in {functionFqn} is not valid for {testType} tests. Valid keys for {testType} tests are: {validKeys}";
                readonly websiteTitle: "Inline config key not valid for test type";
                readonly websiteDescription: "An inline config key was used that does not apply to the type of test function it was attached to. Fuzz test functions (test*) only accept fuzz.* keys and top-level keys, while invariant test functions (invariant*) only accept invariant.* keys and top-level keys.";
            };
            readonly SELECTED_TEST_FILES_NOT_COMPILED: {
                readonly number: 814;
                readonly messageTemplate: "The following Solidity test files have not been compiled:\n\n{files}\n\nRun `hardhat build` to compile your project before running tests with `--no-compile`.";
                readonly websiteTitle: "Selected Solidity test files not compiled";
                readonly websiteDescription: "You ran Solidity tests with `--no-compile`, but some of the selected test files have not been compiled yet. Run `hardhat build` first, or remove the `--no-compile` flag.";
            };
            readonly SELECTED_FILES_ARE_NOT_SOLIDITY_TESTS: {
                readonly number: 815;
                readonly messageTemplate: "Trying to run these files as Solidity tests, but they aren't:\n\n{files}\n\nDouble-check the files that you are providing to the `test solidity` task.";
                readonly websiteTitle: "Invalid Solidity test files";
                readonly websiteDescription: "You ran the `test solidity` task with files that aren't classified as Solidity tests.";
            };
            readonly SELECTED_TEST_FILES_DO_NOT_EXIST: {
                readonly number: 816;
                readonly messageTemplate: "The following Solidity test files do not exist:\n\n{files}\n\nDouble-check the paths you are providing to the `test solidity` task.";
                readonly websiteTitle: "Selected Solidity test files do not exist";
                readonly websiteDescription: "You ran the `test solidity` task with files that do not exist on disk.";
            };
            readonly SNAPSHOT_GROUP_NAME_COLLISION: {
                readonly number: 817;
                readonly messageTemplate: "Snapshot group names \"{nameA}\" and \"{nameB}\" both produce the on-disk filename \"{sanitized}.json\" after sanitization. Rename one of them in your Solidity tests so they produce different filenames.";
                readonly websiteTitle: "Snapshot group name collision after sanitization";
                readonly websiteDescription: "Two distinct snapshot group names sanitize to the same on-disk filename. Rename one of the groups in your Solidity tests so they produce different filenames.";
            };
            readonly EIP712_DUPLICATE_STRUCT_NAME: {
                readonly number: 818;
                readonly messageTemplate: "Two different EIP-712 struct definitions named \"{name}\" were found:\n- {firstSource}\n- {secondSource}\n\nEIP-712 cheatcodes resolve types by name, so each struct name must have a single canonical definition. {remediation}";
                readonly websiteTitle: "Duplicate EIP-712 struct name";
                readonly websiteDescription: "Two struct definitions with the same name had different members. Type-name lookups via `vm.eip712HashType` and `vm.eip712HashStruct` would be ambiguous.";
            };
            readonly SNAPSHOT_TOLERANCE_REQUIRES_CHECK: {
                readonly number: 819;
                readonly messageTemplate: "The --tolerance option can only be used with --snapshot-check.";
                readonly websiteTitle: "Snapshot tolerance requires snapshot check";
                readonly websiteDescription: "The `--tolerance` option only affects snapshot checks, so it can only be used together with `--snapshot-check`.";
            };
            readonly INVALID_SNAPSHOT_TOLERANCE: {
                readonly number: 820;
                readonly messageTemplate: "Invalid --tolerance value {value}. Expected a non-negative finite number.";
                readonly websiteTitle: "Invalid snapshot tolerance";
                readonly websiteDescription: "The `--tolerance` option expects a non-negative finite number representing the allowed gas drift percentage.";
            };
            readonly INVALID_INLINE_CONFIG: {
                readonly number: 821;
                readonly messageTemplate: "Invalid inline test configuration:\n\n{errors}";
                readonly websiteTitle: "Invalid inline test configuration";
                readonly websiteDescription: "One or more inline test configuration directives (`forge-config:` / `hardhat-config:` NatSpec comments) in your Solidity test sources are invalid. Fix the reported directives and run the tests again.";
            };
        };
        readonly SOLIDITY: {
            ...
            readonly UNRECOGNIZED_FILES_NOT_COMPILED: {
                readonly number: 915;
                readonly messageTemplate: "The build process failed because these files you provided haven't been recognized neither as contracts nor tests:\n        \n{files}\n\nSolidity test files must be placed in your test directory, or in your contracts directory and end in .t.sol.";
                readonly websiteTitle: "Build failed due to unrecognized files";
                readonly websiteDescription: "Hardhat failed to build your contracts and/or tests because you passed a file as parameter, but it wasn't recognized neither as a valid contract nor test.\n        \nSolidity test files must be placed in your test directory, or in your contracts directory and end in .t.sol.";
            };
            readonly SPLIT_TESTS_COMPILATION_DISABLED: {
                readonly number: 916;
                readonly messageTemplate: "A method of the SolidityBuildSystem was called with `scope: \"tests\"`, but `splitTestsCompilation` is disabled in your config.\n\nWhen `splitTestsCompilation` is `false`, contracts and tests are compiled together under `scope: \"contracts\"`, so `scope: \"tests\"` is not a valid option.\n\nSet `solidity.splitTestsCompilation` to `true` in your Hardhat config to enable this build scope.";
                readonly websiteTitle: "Split tests compilation is disabled";
                readonly websiteDescription: "The Solidity build system was called with `scope: \"tests\"`, but `splitTestsCompilation` is disabled in your config.\n\nWhen `splitTestsCompilation` is `false`, contracts and tests are compiled together under `scope: \"contracts\"`, so `scope: \"tests\"` is not a valid option.\n\nSet `solidity.splitTestsCompilation` to `true` in your Hardhat config to enable this build scope.";
            };
            readonly INCOMPATIBLE_FILES_WITH_BUILD_FLAGS: {
                readonly number: 917;
                readonly messageTemplate: "Some of the files you are trying to build are incompatible with the `--no-contracts` or `--no-tests` flag you provided:\n\n{files}\n\nTry re-running without these files, or without the flag.";
                readonly websiteTitle: "Incompatible files with build flags";
                readonly websiteDescription: "You are trying to build a list of files while using `--no-contracts` or `--no-tests`, but some of those files are incompatible with the flag you provided.\n\nFor example, you may be trying to build a test file with `--no-tests`, which isn't a valid operation.";
            };
            readonly BUILD_INFO_COMPILER_TYPE_NOT_HANDLED: {
                readonly number: 918;
                readonly messageTemplate: "The build info you are trying to compile was produced by the \"{compilerType}\" compiler (version {version}), but no plugin registered a handler for that compiler type.\n\nMake sure the plugin that provides the \"{compilerType}\" compiler is installed and enabled in your Hardhat config.";
                readonly websiteTitle: "No compiler registered for build info compiler type";
                readonly websiteDescription: "The build info you are trying to compile was produced by a non-`solc` compiler type, but no installed plugin registered a handler for that compiler type.\n\nMake sure the plugin that provides the compiler is installed and enabled in your Hardhat config.";
            };
            readonly BUILD_INFO_OUTPUT_PARSE_ERROR: {
                readonly number: 919;
                readonly messageTemplate: "Failed to parse the compilation output for build info \"{buildInfoId}\".\n\nThis usually means the artifact is corrupted. Recompiling your project should fix it.";
                readonly websiteTitle: "Failed to parse build info output";
                readonly websiteDescription: "Hardhat could not parse the compilation output of a build info. The artifact is likely corrupted.";
            };
        };
        readonly ARTIFACTS: {
            readonly NOT_FOUND: {
        ...
        readonly INIT: {
            readonly FAILED_TO_INSTALL_DEPENDENCIES: {
                readonly number: 1400;
                readonly messageTemplate: "Failed to install the project dependencies.\n\nPlease try again. If it persists, please open an issue in the Hardhat repository.";
                readonly websiteTitle: "Failed to install the project dependencies";
                readonly websiteDescription: "The project initialization failed to install the required dependencies";
            };
        };
    };
    readonly IGNITION: {
        ...
        readonly EXECUTION: {
            ...
            readonly NONCE_TOO_HIGH: {
                readonly number: 10411;
                readonly messageTemplate: "The next nonce for {sender} should be {expectedNonce}, but the node reports {pendingCount}. This usually means a transaction was sent from {sender} outside of Hardhat Ignition. Please make sure not to send transactions from {sender} while running this deployment and try again.";
                readonly websiteTitle: "Nonce too high";
                readonly websiteDescription: "The node reports more pending transactions than Hardhat Ignition expected for the sender";
            };
            readonly NONCE_TOO_LOW: {
                readonly number: 10412;
                readonly messageTemplate: "The next nonce for {sender} should be {expectedNonce}, but the node reports {pendingCount} after retries. This may indicate a dropped transaction or the node's mempool has not caught up. Please try running the deployment again.";
                readonly websiteTitle: "Nonce too low";
                readonly websiteDescription: "The node reports fewer pending transactions than Hardhat Ignition expected for the sender";
            };
        };
    ...
    readonly HARDHAT_ETHERS: {
        readonly GENERAL: {
            ...
            readonly MISSING_LINK_FOR_LIBRARY: {
                ...
                readonly messageTemplate: "The contract \"{contractName}\" is missing links for the following libraries: \"{missingLibraries}\". Learn more about linking contracts at (https://hardhat.org/ethers-library-linking).";
    ...
    readonly HARDHAT_MOCHA: {
        readonly GENERAL: {
            ...
            readonly GREP_EXCLUDE_INCOMPATIBLE_OPTION: {
                readonly number: 30001;
                readonly messageTemplate: "The --grep-exclude option cannot be combined with the Mocha \"{option}\" config option.";
                readonly websiteTitle: "Incompatible --grep-exclude option";
                readonly websiteDescription: "--grep-exclude is applied by merging it with --grep into Mocha's single name filter, so it cannot be combined with the `fgrep` or `invert` Mocha config options. Remove the conflicting option from your config, or express your filter using --grep and --grep-exclude only.";
            };
            readonly INVALID_GREP_EXCLUDE_COMBINATION: {
                readonly number: 30002;
                readonly messageTemplate: "The {name} pattern \"{grep}\" and the --grep-exclude pattern \"{grepExclude}\" cannot be combined into a valid regular expression.";
                readonly websiteTitle: "Invalid --grep-exclude combination";
                readonly websiteDescription: "--grep and --grep-exclude are merged into a single regular expression. The combination was not valid, which usually happens when both patterns define a capture group with the same name. Rename or remove the duplicated group.";
            };
            readonly GREP_EXCLUDE_UNSUPPORTED_PATTERN: {
                readonly number: 30003;
                readonly messageTemplate: "The {name} pattern \"{pattern}\" uses {feature}, which is not supported together with --grep-exclude.";
                readonly websiteTitle: "Unsupported --grep-exclude pattern";
            ...
            readonly GREP_INCOMPATIBLE_OPTION: {
                readonly number: 30004;
                readonly messageTemplate: "The --grep option cannot be combined with the Mocha \"fgrep\" config option.";
                readonly websiteTitle: "Incompatible --grep option";
                readonly websiteDescription: "--grep and the `fgrep` Mocha config option are competing name filters, and Mocha applies only one of them; its own CLI rejects the pair as mutually exclusive. Remove `fgrep` from your config, or run without --grep.";
            };
        };
    };
    ...
    readonly HARDHAT_FOUNDRY: {
        readonly GENERAL: {
            readonly FORGE_NOT_INSTALLED: {
                readonly number: 100000;
                readonly messageTemplate: "Couldn't run `forge`. Please check that Foundry is installed and that `forge` is in your PATH.\n\nIf you need to install Foundry, please go to https://getfoundry.sh";
                readonly websiteTitle: "Forge not installed";
                readonly websiteDescription: "You tried to use the hardhat-foundry plugin, but Foundry is not installed or `forge` is not in your PATH.\n\nIf you need to install Foundry, please go to https://getfoundry.sh";
            };
            readonly FORGE_REMAPPINGS_FAILED: {
                readonly number: 100001;
                readonly messageTemplate: "Running `forge remappings` in \"{packagePath}\" failed.\n\nError: {stderr}";
                readonly websiteTitle: "Forge remappings command failed";
                readonly websiteDescription: "The `forge remappings` command failed when trying to read remappings for a package.\n\nThis could be due to:\n- An invalid foundry.toml configuration\n- Missing dependencies\n- Forge installation issues\n\nCheck the error message for more details and verify your foundry.toml configuration.";
            };
        };
    };
    readonly HARDHAT_SLANG_SOLX: {
        readonly GENERAL: {
            readonly UNSUPPORTED_PLATFORM: {
                readonly number: 110000;
                readonly messageTemplate: "solx is not available for the current platform ({platform}/{arch}).\n\nsolx supports: linux/x64, linux/arm64, darwin (macOS), windows/x64.";
                readonly websiteTitle: "Unsupported platform";
                readonly websiteDescription: "The solx compiler is not available for your current operating system and architecture combination.\n\nsolx supports: linux/x64, linux/arm64, darwin (macOS), windows/x64.";
            };
            readonly DOWNLOAD_FAILED: {
                readonly number: 110001;
                readonly messageTemplate: "Failed to download solx {version} after {attempts} attempts: {reason}";
                readonly websiteTitle: "solx download failed";
                readonly websiteDescription: "The solx compiler binary could not be downloaded from the solx releases mirror used by Hardhat.\n\nCheck your internet connection, ensure that the solx releases mirror (https://solx-releases-mirror.hardhat.org) is reachable from your environment, and verify that the requested solx version exists.";
            };
            readonly BINARY_NOT_FOUND: {
                readonly number: 110002;
                readonly messageTemplate: "solx binary not found at {path}";
                readonly websiteTitle: "solx binary not found";
                readonly websiteDescription: "The configured custom path for the solx binary does not exist.\n\nVerify that the path in your Hardhat config points to a valid solx binary.";
            };
            readonly CHECKSUM_DOWNLOAD_FAILED: {
                readonly number: 110003;
                readonly messageTemplate: "Couldn't download the checksum for solx {version} from {url}: {reason}";
                readonly websiteTitle: "Couldn't obtain the solx checksum";
                readonly websiteDescription: "Every solx binary is published alongside a `.sha256` checksum file, which Hardhat uses to verify the download. Hardhat couldn't obtain that checksum, so it refused to use the binary.\n\nCheck your internet connection, and ensure that the solx releases mirror (https://solx-releases-mirror.hardhat.org) is reachable from your environment. If you are behind a proxy that intercepts HTTPS traffic, it may be blocking or rewriting the request.";
            };
            readonly INVALID_DOWNLOAD: {
                readonly number: 110004;
                readonly messageTemplate: "Couldn't download solx {version}: Checksum verification failed.\n\nPlease check your internet connection and try again.\n\nIf this error persists, run \"npx hardhat clean --global\".";
                readonly websiteTitle: "Downloaded solx checksum verification failed";
                readonly websiteDescription: "Hardhat downloaded a solx binary, and its checksum didn't match the one published alongside it. The binary was deleted instead of being used.\n\nThe likeliest cause is a corrupted or incomplete download.\n\nPlease check your internet connection and try again. If this error persists, run `npx hardhat clean --global`.";
            };
        };
    };
    readonly HARDHAT_NODE_TEST_RUNNER: {
        readonly GENERAL: {
            readonly GREP_EXCLUDE_NOT_SUPPORTED: {
                readonly number: 120000;
                readonly messageTemplate: "The --grep-exclude option is not supported by the node:test runner.";
                readonly websiteTitle: "Unsupported --grep-exclude option";
                readonly websiteDescription: "The node:test runner executes tests with isolation disabled, and in that mode Node.js currently ignores the test skip pattern used to implement --grep-exclude (see https://github.com/nodejs/node/issues/64359). Because the exclusion cannot be applied reliably, the option is rejected instead of being silently ignored.\n\nRemove --grep-exclude, or run the tests that need it through the Mocha or Solidity test runners, which support it.";
            };
        };
    };
};
