...
You can learn how to use Hardhat by reading the [Getting Started guide](/getting-started).`,
            ...
            DUPLICATED_PLUGIN_ID: {
                number: 2,
                messageTemplate: 'Duplicated plugin id "{id}" found. Did you install multiple versions of the same plugin?',
...
Please double check whether you have multiple versions of the same plugin installed.`,
            ...
            NO_CONFIG_FILE_FOUND: {
                ...
                websiteDescription: "Hardhat couldn't find a config file in the current directory or any of its parents.",
            },
            INVALID_CONFIG_PATH: {
                number: 4,
            ...
            INVALID_CONFIG_OBJECT: {
                ...
                websiteDescription: "The config file doesn't export a valid configuration object.",
            },
            ENV_VAR_NOT_FOUND: {
                number: 7,
...
You can define it using a plugin like hardhat-keystore, or set it as an environment variable.`,
            ...
            HARDHAT_PROJECT_ALREADY_CREATED: {
                number: 10,
                messageTemplate: "You are trying to initialize a project inside an existing Hardhat project. The path to the project's configuration file is: {hardhatProjectRootPath}.",
            ...
            NOT_IN_INTERACTIVE_SHELL: {
                number: 11,
                messageTemplate: "You are trying to initialize a project but you are not in an interactive shell.",
...
Please add the property "type" with the value "module" in your package.json to ensure that your project is recognized as an ESM project.`,
            ...
            GLOBAL_OPTION_ALREADY_DEFINED: {
                number: 14,
                messageTemplate: 'Plugin "{plugin}"" is trying to define the global option "{globalOption}" but it is already defined by plugin "{definedByPlugin}"',
                websiteTitle: "Global option already defined",
                websiteDescription: "The global option is already defined by another plugin. Please ensure that global options are uniquely named to avoid conflicts.",
            },
            INVALID_CONFIG: {
                number: 15,
...
Please [report it](https://github.com/nomiclabs/hardhat/issues/new) to help us improve Hardhat.`,
        ...
        PLUGINS: {
            ...
            PLUGIN_MISSING_DEPENDENCY: {
                number: 201,
                messageTemplate: 'Plugin "{pluginId}" is missing a peer dependency "{peerDependencyName}".',
                websiteTitle: "Plugin missing peer dependency",
                websiteDescription: `A plugin's peer dependency has not been installed.`,
            },
            DEPENDENCY_VERSION_MISMATCH: {
                number: 202,
                messageTemplate: 'Plugin "{pluginId}" has a peer dependency "{peerDependencyName}" with expected version "{expectedVersion}" but the installed version is "{installedVersion}".',
...
Please install a version of the peer dependency that meets the plugin's requirements.`,
        ...
        HOOKS: {
            INVALID_HOOK_FACTORY_PATH: {
                number: 300,
                messageTemplate: 'Plugin "{pluginId}" hook factory for "{hookCategoryName}" is not a valid file:// URL: {path}.',
            ...
            FAILED_TO_LOAD_HOOK_HANDLER_FACTORY: {
                number: 302,
                messageTemplate: 'Plugin "{pluginId}" hook factory for "{hookCategoryName}" threw an error while being loaded.',
...
Please ensure that an action is defined for each task.`,
            ...
            POSITIONAL_ARG_AFTER_VARIADIC: {
                number: 402,
                messageTemplate: 'Cannot add the positional argument "{name}" after a variadic one',
                websiteTitle: "Invalid task definition",
                websiteDescription: "A variadic argument must always be the last positional argument in a task definition.",
            },
            REQUIRED_ARG_AFTER_OPTIONAL: {
                number: 403,
                messageTemplate: 'Cannot add required positional argument "{name}" after an optional one',
                websiteTitle: "Invalid task definition",
                websiteDescription: "Required positional arguments must be defined before optional ones in a task definition.",
            },
            TASK_NOT_FOUND: {
                number: 404,
            ...
            SUBTASK_WITHOUT_PARENT: {
                number: 405,
                messageTemplate: 'Task "{task}" not found when attempting to define subtask "{subtask}". If you intend to only define subtasks, please first define "{task}" as an empty task',
                websiteTitle: "Subtask without parent",
                websiteDescription: "The parent task of the subtask being defined was not found. If you intend to only define subtasks, please first define the parent task as an empty task.",
            },
            TASK_ALREADY_DEFINED: {
                number: 406,
                messageTemplate: '{actorFragment} trying to define the task "{task}" but it is already defined{definedByFragment}',
                websiteTitle: "Task already defined",
                websiteDescription: "The task is already defined. Please ensure that tasks are uniquely named to avoid conflicts.",
            },
            EMPTY_TASK_ID: {
                number: 407,
                messageTemplate: "Task id cannot be an empty string or an empty array",
                websiteTitle: "Empty task id",
                websiteDescription: "The task id cannot be an empty string or an empty array. Please ensure that the array of task names is not empty.",
            },
            TASK_OPTION_ALREADY_DEFINED: {
                number: 408,
                messageTemplate: '{actorFragment} trying to define task "{task}" with the option "{option}" but it is already defined as a global option by plugin "{globalOptionPluginId}"',
                websiteTitle: "Task option already defined",
                websiteDescription: "The task option is already defined as a global option by another plugin. Please ensure that task options are uniquely named to avoid conflicts.",
            },
            TASK_OVERRIDE_OPTION_ALREADY_DEFINED: {
                number: 409,
                messageTemplate: '{actorFragment} trying to override the option "{option}" of the task "{task}" but it is already defined',
                websiteTitle: "Task override option already defined",
                websiteDescription: "An attempt is being made to override an option that has already been defined. Please ensure that the option is not defined before trying to override it.",
            },
            EMPTY_TASK: {
                number: 410,
                messageTemplate: `Can't run the empty task "{task}"`,
                websiteTitle: "Empty task",
                websiteDescription: "The task is empty. Please ensure that tasks have at least one action.",
            },
            INVALID_ACTION_IMPORT: {
                ...
                websiteDescription: "Unable to import action for task. Please verify that the the file exists and that it provides a default function export.",
            },
            INVALID_ACTION: {
                number: 412,
                messageTemplate: 'The action resolved in task "{task}" is not a function',
                websiteTitle: "Invalid action",
                websiteDescription: "The action of the task is not a function. Make sure that the file pointed to by the action URL exports a function as the default export.",
            },
            MISSING_VALUE_FOR_TASK_ARGUMENT: {
                number: 413,
                messageTemplate: 'Missing value for the argument named "{argument}" in the task "{task}"',
...
Please double check how you invoked Hardhat or ran your task.`,
            ...
            INVALID_VALUE_FOR_TYPE: {
                number: 414,
                messageTemplate: 'Invalid value "{value}" for argument "{name}" of type "{type}" in the task "{task}"',
...
Please double check your arguments.`,
            ...
            UNRECOGNIZED_SUBTASK: {
                number: 416,
                messageTemplate: 'Unrecognized subtask "{invalidSubtask}" for the task "{task}"',
...
Please remove one of the two action definitions.`,
        ...
        ARGUMENTS: {
            INVALID_VALUE_FOR_TYPE: {
                number: 500,
                messageTemplate: 'Invalid value "{value}" for argument "{name}" of type "{type}"',
                websiteTitle: "Invalid argument type",
...
Please double check your arguments.`,
            ...
            UNRECOGNIZED_OPTION: {
                number: 504,
                messageTemplate: 'Invalid option "{option}". It is neither a valid global option nor associated with any task. Did you forget to add the task first, or did you misspell it?',
                websiteTitle: "Invalid option value",
...
Please double check how you invoked Hardhat or ran your task.`,
            ...
            UNUSED_ARGUMENT: {
                number: 506,
                messageTemplate: 'The argument with value "{value}" was not consumed because it is not associated with any task.',
...
Please double check how you invoked Hardhat or ran your task.`,
            ...
            MISSING_CONFIG_FILE: {
                number: 507,
                messageTemplate: 'The global option "--config" was passed, but no file path was provided.',
...
Please double check your arguments.`,
            ...
            CANNOT_COMBINE_INIT_AND_CONFIG_PATH: {
                number: 508,
                messageTemplate: 'The global option "--config" cannot be used with the "init" command',
                websiteTitle: 'The global option "--config" cannot be used with the "init" command',
...
Please double check your arguments.`,
            ...
            CANNOT_GROUP_OPTIONS: {
                number: 509,
                messageTemplate: 'Invalid option "{option}". Options cannot be grouped together. Try providing the options separately.',
...
Please double check your arguments, and try providing the options separately.`,
            ...
            CANNOT_REPEAT_OPTIONS: {
                number: 510,
                messageTemplate: 'Invalid option "{option}". Options of type "{type}" cannot be repeated.',
...
Please double check your arguments.`,
            ...
            NO_HIDDEN_OPTION_CLI: {
                number: 512,
                messageTemplate: 'The option "{option}" is hidden and cannot be used from the CLI.',
            ...
            CANNOT_COMBINE_TEMPLATE_AND_TEMPLATES: {
                number: 513,
                messageTemplate: 'The options "--template" and "--templates" cannot be used together. Use "--init --template <name>" to initialize a project with a specific template, or "--init --templates" to list the available templates.',
                websiteTitle: 'The options "--template" and "--templates" cannot be used together',
...
Use "--init --template <name>" to initialize a project with a specific template, or "--init --templates" to list the available templates.`,
            ...
            MUTUALLY_EXCLUSIVE_OPTIONS: {
                number: 514,
                messageTemplate: 'The options "--{optionA}" and "--{optionB}" cannot be used together',
...
Please double check your arguments.`,
            ...
            INVALID_VALUE: {
                number: 515,
                messageTemplate: 'Invalid value "{value}" for argument "{name}": {reason}',
...
If you need to flatten your project, refactor your Solidity sources to remove the cycle. Cyclic imports are usually avoidable, and removing them tends to make code easier to reason about.`,
            },
        },
        NETWORK: {
            INVALID_URL: {
...
Please check that you are sending a valid URL string for the network or forking \`URL\` parameter.`,
            ...
            INVALID_REQUEST_PARAMS: {
                number: 701,
                messageTemplate: "Invalid request arguments: only array parameters are supported.",
                websiteTitle: "Invalid method parameters",
                websiteDescription: "The JSON-RPC request parameters are invalid. You are trying to make an EIP-1193 request with object parameters, but only array parameters are supported. Ensure that the 'params' parameter is correctly specified as an array in your JSON-RPC request.",
            },
...
{errors}`,
            ...
            INVALID_GLOBAL_CHAIN_ID: {
                number: 708,
                messageTemplate: 'Hardhat was set to use chain id "{configChainId}", but connected to a chain with id "{connectionChainId}".',
            ...
            NO_REMOTE_ACCOUNT_AVAILABLE: {
                number: 709,
                messageTemplate: "No local account was set and there are accounts in the remote node.",
                websiteTitle: "No remote account available",
                websiteDescription: "No local account was set and there are accounts in the remote node",
            },
...
Please double check your transactions' parameters.`,
            ...
            MISSING_FEE_PRICE_FIELDS: {
                number: 714,
                messageTemplate: "Tried to sign a transaction locally, but gasPrice, maxFeePerGas, and maxPriorityFeePerGas were missing.",
...
Please double check your transactions' parameters.`,
            ...
            INCOMPATIBLE_FEE_PRICE_FIELDS: {
                number: 715,
                messageTemplate: "An incompatible transaction with gasPrice and EIP-1559 fee price fields.",
...
Try using another mnemonic or deriving less keys.`,
            ...
            WRONG_VALIDATION_PARAMS: {
                number: 719,
                messageTemplate: "Validation of parameters against the schemas failed for the following reason: {reason}",
                websiteTitle: "Invalid validation parameters",
                websiteDescription: "The validation of parameters against the schemas failed.",
            },
            INVALID_NETWORK_TYPE: {
                number: 720,
                messageTemplate: 'The provided network type "{networkType}" for network "{networkName}" is not recognized, only `http` and `edr` are supported.',
            ...
            DATA_FIELD_CANNOT_BE_NULL_WITH_NULL_ADDRESS: {
                ...
                websiteDescription: "The transaction to the null address cannot have undefined data",
            },
            PROVIDER_CLOSED: {
                number: 722,
                messageTemplate: "The provider has been closed.",
                websiteTitle: "Provider closed",
                websiteDescription: "The provider you are trying to use has been closed. Please create a new one using hre.network.create() and try again.",
            },
            INCOMPATIBLE_EIP7702_FIELDS: {
                number: 723,
                messageTemplate: "An incompatible transaction with gasPrice and EIP-7702 fields.",
...
Please double check your transactions' parameters.`,
            ...
            CREATE_SERVER_UNSUPPORTED_NETWORK_TYPE: {
                number: 724,
                messageTemplate: 'Cannot create a server for network "{networkName}" because it has type "{networkType}". Only "edr-simulated" networks are supported.',
                websiteTitle: "Unsupported network type for createServer",
                websiteDescription: "The createServer method only supports 'edr-simulated' networks. HTTP networks cannot be used to create a local JSON-RPC server.",
            },
        },
        SOLIDITY_TESTS: {
...
Remaining test suites: {suites}`,
            ...
            UNHANDLED_EDR_ERROR_SOLIDITY_TESTS: {
                number: 802,
                shouldBeReported: true,
                messageTemplate: "Unhandled EDR error while running Solidity tests: {error}",
            ...
            INVALID_SNAPSHOT_FORMAT: {
                number: 803,
                messageTemplate: "Invalid format in snapshot file {file} at line {line}. Expected format: {expectedFormat}.",
                websiteTitle: "Invalid snapshot format",
                websiteDescription: "The snapshot file contains a line with an invalid format.",
            },
            SNAPSHOT_READ_ERROR: {
                number: 804,
                messageTemplate: "Error reading snapshot file at {snapshotsPath}: {error}",
            ...
            MUTUALLY_EXCLUSIVE_SNAPSHOT_FLAGS: {
                number: 806,
                messageTemplate: "The flags --snapshot and --snapshot-check are mutually exclusive.",
                websiteTitle: "Mutually exclusive snapshot flags",
                websiteDescription: "The flags --snapshot and --snapshot-check are mutually exclusive. Please provide only one of them.",
            },
            INLINE_CONFIG_INVALID_KEY: {
                ...
                websiteDescription: "An unrecognized key was used in an inline config comment.",
            },
            INLINE_CONFIG_DUPLICATE_KEY: {
                ...
                websiteDescription: "The same configuration key was specified more than once for the same test function.",
            },
            INLINE_CONFIG_INVALID_VALUE: {
                ...
                websiteDescription: "The value provided for an inline config key could not be parsed as the expected type.",
            },
            INLINE_CONFIG_UNSUPPORTED_PROFILE: {
                ...
                websiteDescription: "An inline config comment used a non-default profile, which is not supported by Hardhat.",
            },
            INLINE_CONFIG_INVALID_SYNTAX: {
                ...
                websiteDescription: "An inline config comment was found but its syntax could not be parsed.",
            },
            INLINE_CONFIG_UNRESOLVED_SELECTOR: {
                ...
                websiteDescription: "An inline config comment was found on a function that does not have a function selector. This usually means the function is internal or private, and therefore cannot be run as a test.",
            },
            INLINE_CONFIG_INVALID_KEY_FOR_TEST_TYPE: {
                ...
                websiteDescription: "An inline config key was used that does not apply to the type of test function it was attached to. Fuzz test functions (test*) only accept fuzz.* keys and top-level keys, while invariant test functions (invariant*) only accept invariant.* keys and top-level keys.",
            },
...
Double-check the paths you are providing to the \`test solidity\` task.`,
            ...
            SNAPSHOT_GROUP_NAME_COLLISION: {
                ...
                websiteDescription: "Two distinct snapshot group names sanitize to the same on-disk filename. Rename one of the groups in your Solidity tests so they produce different filenames.",
            },
...
EIP-712 cheatcodes resolve types by name, so each struct name must have a single canonical definition. {remediation}`,
            ...
            SNAPSHOT_TOLERANCE_REQUIRES_CHECK: {
                number: 819,
                messageTemplate: "The --tolerance option can only be used with --snapshot-check.",
                websiteTitle: "Snapshot tolerance requires snapshot check",
                websiteDescription: "The `--tolerance` option only affects snapshot checks, so it can only be used together with `--snapshot-check`.",
            },
            INVALID_SNAPSHOT_TOLERANCE: {
                number: 820,
                messageTemplate: "Invalid --tolerance value {value}. Expected a non-negative finite number.",
                websiteTitle: "Invalid snapshot tolerance",
                websiteDescription: "The `--tolerance` option expects a non-negative finite number representing the allowed gas drift percentage.",
            },
...
{errors}`,
                ...
                websiteDescription: "One or more inline test configuration directives (`forge-config:` / `hardhat-config:` NatSpec comments) in your Solidity test sources are invalid. Fix the reported directives and run the tests again.",
            },
        },
        SOLIDITY: {
...
If you are certain it has been released, run \`npx hardhat clean --global\` and try again.`,
            ...
            DOWNLOAD_FAILED: {
                number: 904,
                messageTemplate: "Couldn't download compiler version {remoteVersion}. Please check your internet connection and try again.",
...
Please check your internet connection and try again.`,
            ...
            VERSION_LIST_DOWNLOAD_FAILED: {
                number: 905,
                messageTemplate: "Couldn't download compiler version list. Please check your internet connection and try again.",
...
This usually means the artifact is corrupted. Recompiling your project should fix it.`,
                ...
                websiteDescription: "Hardhat could not parse the compilation output of a build info. The artifact is likely corrupted.",
            },
        },
        ARTIFACTS: {
            NOT_FOUND: {
                number: 1000,
                messageTemplate: 'Artifact for contract "{contractName}" not found. {suggestion}',
...
Please try again. If it persists, please open an issue in the Hardhat repository.`,
    ...
    IGNITION: {
        GENERAL: {
            ASSERTION_ERROR: {
                number: 10000,
                messageTemplate: "Internal Hardhat Ignition invariant was violated: {description}",
            ...
            UNSUPPORTED_DECODE: {
                number: 10001,
                messageTemplate: "Hardhat Ignition can't decode ethers.js value of type {type}: {value}",
                websiteTitle: "Unsupported ethers.js value",
                websiteDescription: "Unsupported ethers.js value",
            },
            ARTIFACT_MIGRATION_NEEDED: {
                number: 10002,
                messageTemplate: "Hardhat Ignition needs to migrate this deployments artifacts to the new format. Please run `npx hardhat ignition migrate {deploymentId}`",
                websiteTitle: "Artifact migration needed",
                websiteDescription: "Hardhat Ignition needs to migrate the artifacts to the new format. Please run `npx hardhat ignition migrate {deploymentId}`",
            },
        },
        INTERNAL: {
            INTERNAL_ERROR: {
            ...
            TEMPLATE_INVALID_VARIABLE_NAME: {
                number: 10101,
                messageTemplate: "Variable names can only include ascii letters and numbers, and start with a letter, but got {variable}",
            ...
            TEMPLATE_VARIABLE_NOT_FOUND: {
                number: 10102,
                messageTemplate: "Variable {variable}'s tag not present in the template",
            ...
            TEMPLATE_VALUE_CONTAINS_VARIABLE_TAG: {
                number: 10103,
                messageTemplate: "Template values can't include variable tags, but {variable}'s value includes one",
            ...
            CANNOT_RESET_EPHEMERAL_NETWORK: {
                number: 10105,
                messageTemplate: "Deploy cancelled: Cannot reset deployment on ephemeral Hardhat network",
            ...
            NO_MODULES_FOUND: {
                ...
                websiteDescription: "Ignition was unable to find the module requested for deployment.",
            },
            FAILED_TO_PARSE_JSON: {
                number: 10107,
                messageTemplate: "Could not parse JSON parameters",
                websiteTitle: "Could not parse JSON parameters",
                websiteDescription: "Ignition failed to parse the JSON parameters for deployment. Review the JSON and try again.",
            },
            INVALID_DEPLOYMENT_ID: {
                ...
                websiteDescription: "The deployment-id being used for the Hardhat Ignition deployment contains banned characters. Deployment ids can only contain alphanumerics, dashes or underscores.",
            },
            IGNITION_CLIENT_EXTENSION_NOT_INSTALLED: {
                number: 10109,
                messageTemplate: "Please install either `@nomicfoundation/hardhat-ignition-viem` or `@nomicfoundation/hardhat-ignition-ethers` to use Ignition in your Hardhat tests",
                websiteTitle: "Neither the `viem` or `ethers` Ignition extension plugin is installed.",
                websiteDescription: "Please install either `@nomicfoundation/hardhat-ignition-viem` or `@nomicfoundation/hardhat-ignition-ethers` to use Ignition in your Hardhat tests",
            },
            UNKNOWN_TRANSACTION_TYPE: {
                number: 10110,
                messageTemplate: `Unknown transaction type: "{type}"`,
                websiteTitle: "Hardhat Ignition was unable to display an unknown transaction type",
                websiteDescription: "Hardhat Ignition was unable to display an unknown transaction type",
            },
            ...
            MODULE_VALIDATION_FAILED: {
                number: 10112,
                messageTemplate: "Module validation failed. Check the stack trace above to identify the issue and its source code location.",
                websiteTitle: "Module validation failed.",
                websiteDescription: "Hardhat Ignition found problems while validating the module. Please review the module and try again.",
            },
            ...
            MODULE_NOT_FOUND_AT_PATH: {
                ...
                websiteDescription: "Hardhat Ignition was not able to find an Ignition Module at the given path.",
            },
            MODULE_OUTSIDE_MODULE_DIRECTORY: {
                ...
                websiteDescription: "Ignition modules must be located within the module directory.",
            },
            ...
            ARTIFACT_PATH_NOT_FOUND: {
                ...
                websiteTitle: "Hardhat Ignition unable to find artifact path for the contract name",
                websiteDescription: "Hardhat Ignition unable to find artifact path for the contract name",
            },
            ONLY_ONE_IGNITION_EXTENSION_PLUGIN_ALLOWED: {
                number: 10119,
                messageTemplate: "Found ethers and viem, but only one Hardhat Ignition extension plugin can be used at a time",
...
Please review the error message and try again.`,
            ...
            NO_DEFAULT_VIEM_WALLET_CLIENT: {
                number: 10121,
                messageTemplate: "No default wallet client found while creating Viem contract instances for deployed contracts",
        ...
        MODULE: {
            ...
            INVALID_MODULE_ID_CHARACTERS: {
                number: 10201,
                messageTemplate: 'The moduleId "{moduleId}" is invalid. Module ids can only have alphanumerics and underscore, and they must start with an alphanumeric.',
            ...
            ASYNC_MODULE_DEFINITION_FUNCTION: {
                number: 10203,
                messageTemplate: "The callback passed to 'buildModule' for {moduleDefinitionId} returns a Promise; async callbacks are not allowed in 'buildModule'.",
                websiteTitle: "Async module definition function",
                websiteDescription: `Async callbacks are not allowed in 'buildModule'.`,
            },
            DUPLICATE_MODULE_ID: {
                number: 10204,
                messageTemplate: "The following module ids are duplicated: {duplicateModuleIds}. Please make sure all module ids are unique.",
        ...
        SERIALIZATION: {
            INVALID_FUTURE_ID: {
                number: 10300,
                messageTemplate: "Unable to lookup future during deserialization: {futureId}",
        ...
        EXECUTION: {
            DROPPED_TRANSACTION: {
                number: 10400,
                messageTemplate: "Error while executing {futureId}: all the transactions of its network interaction {networkInteractionId} were dropped. Please try rerunning Hardhat Ignition.",
            ...
            WAITING_FOR_CONFIRMATIONS: {
                number: 10402,
                messageTemplate: "You have sent transactions from {sender} and they interfere with Hardhat Ignition. Please wait until they get {requiredConfirmations} confirmations before running Hardhat Ignition again.",
                websiteTitle: "Waiting for confirmations",
                websiteDescription: `Waiting for confirmations for transactions sent from the sender`,
            },
            WAITING_FOR_NONCE: {
                number: 10403,
                messageTemplate: "You have sent transactions from {sender} with nonce {nonce} and it interferes with Hardhat Ignition. Please wait until they get {requiredConfirmations} confirmations before running Hardhat Ignition again.",
                websiteTitle: "Waiting for nonce",
                websiteDescription: `Waiting for confirmations for transactions sent from the sender`,
            },
            INVALID_NONCE: {
                number: 10404,
                messageTemplate: "The next nonce for {sender} should be {expectedNonce}, but is {pendingCount}. Please make sure not to send transactions from {sender} while running this deployment and try again.",
            ...
            BASE_FEE_EXCEEDS_GAS_LIMIT: {
                number: 10405,
                messageTemplate: "The configured base fee exceeds the block gas limit. Please reduce the configured base fee or increase the block gas limit.",
            ...
            MAX_FEE_PER_GAS_EXCEEDS_GAS_LIMIT: {
                number: 10406,
                messageTemplate: "The calculated max fee per gas exceeds the configured limit.",
            ...
            INSUFFICIENT_FUNDS_FOR_TRANSFER: {
                number: 10407,
                messageTemplate: "Account {sender} has insufficient funds to transfer {amount} wei",
            ...
            INSUFFICIENT_FUNDS_FOR_DEPLOY: {
                number: 10408,
                messageTemplate: "Account {sender} has insufficient funds to deploy the contract",
...
npx hardhat ignition track-tx <txHash> <deploymentId> --network <networkName>`,
            ...
            NONCE_TOO_HIGH: {
                number: 10411,
                messageTemplate: "The next nonce for {sender} should be {expectedNonce}, but the node reports {pendingCount}. This usually means a transaction was sent from {sender} outside of Hardhat Ignition. Please make sure not to send transactions from {sender} while running this deployment and try again.",
            ...
            NONCE_TOO_LOW: {
                number: 10412,
                messageTemplate: "The next nonce for {sender} should be {expectedNonce}, but the node reports {pendingCount} after retries. This may indicate a dropped transaction or the node's mempool has not caught up. Please try running the deployment again.",
        ...
        WIPE: {
            UNINITIALIZED_DEPLOYMENT: {
                number: 10600,
                messageTemplate: "Cannot wipe {futureId} as the deployment hasn't been intialialized yet",
            ...
            NO_STATE_FOR_FUTURE: {
                number: 10601,
                messageTemplate: "Cannot wipe {futureId} as it has no previous execution recorded",
        ...
        VALIDATION: {
            INVALID_DEFAULT_SENDER: {
                number: 10700,
                messageTemplate: "Default sender {defaultSender} is not part of the configured accounts.",
                websiteTitle: "Invalid default sender",
                websiteDescription: `The default sender is not part of the configured accounts`,
            },
            MISSING_EMITTER: {
                number: 10701,
                messageTemplate: "`options.emitter` must be provided when reading an event from a SendDataFuture",
            ...
            INVALID_CONSTRUCTOR_ARGS_LENGTH: {
                number: 10703,
                messageTemplate: "The constructor of the contract '{contractName}' expects {expectedArgsLength} arguments but {argsLength} were given",
            ...
            INVALID_FUNCTION_ARGS_LENGTH: {
                number: 10704,
                messageTemplate: "Function {functionName} in contract {contractName} expects {expectedLength} arguments but {argsLength} were given",
                websiteTitle: "Invalid function arguments length",
                websiteDescription: `Invalid function arguments length`,
            },
            INVALID_STATIC_CALL: {
                number: 10705,
                messageTemplate: "Function {functionName} in contract {contractName} is not 'pure' or 'view' and should not be statically called",
                websiteTitle: "Invalid static call",
                websiteDescription: `Function is not 'pure' or 'view' and should not be statically called`,
            },
            INDEXED_EVENT_ARG: {
                number: 10706,
                messageTemplate: "Indexed argument {argument} of event {eventName} of contract {contractName} is not stored in the receipt (its hash is stored instead), so you can't read it.",
            ...
            OVERLOAD_NOT_FOUND: {
                number: 10708,
                messageTemplate: "{eventOrFunction} '{name}' not found in contract {contractName}",
                websiteTitle: "Overload not found",
                websiteDescription: `Overload not found`,
            },
            REQUIRE_BARE_NAME: {
                number: 10709,
                messageTemplate: "{eventOrFunction} name '{name}' used for contract {contractName}, but it's not overloaded. Use '{bareName}' instead.",
...
{normalizedNameList}`,
            ...
            EVENT_ARG_NOT_FOUND: {
                number: 10712,
                messageTemplate: "Event {eventName} of contract {contractName} has no argument named {argument}",
                websiteTitle: "Event argument not found",
                websiteDescription: `Event argument not found`,
            },
            INVALID_EVENT_ARG_INDEX: {
                number: 10713,
                messageTemplate: "Event {eventName} of contract {contractName} has only {expectedLength} arguments, but argument {argument} was requested",
                websiteTitle: "Invalid event argument index",
                websiteDescription: `Invalid event argument index`,
            },
            FUNCTION_ARG_NOT_FOUND: {
                number: 10714,
                messageTemplate: "Function {functionName} of contract {contractName} has no return value named {argument}",
                websiteTitle: "Function argument not found",
                websiteDescription: `Function argument not found`,
            },
            INVALID_FUNCTION_ARG_INDEX: {
                number: 10715,
                messageTemplate: "Function {functionName} of contract {contractName} has only {expectedLength} return values, but value {argument} was requested",
                websiteTitle: "Invalid function argument index",
                websiteDescription: `Invalid function argument index`,
            },
            MISSING_LIBRARIES: {
                number: 10716,
                messageTemplate: "Invalid libraries for contract {contractName}: The following libraries are missing: {fullyQualifiedNames}",
                websiteTitle: "Missing libraries",
                websiteDescription: `The following libraries are missing`,
            },
            CONFLICTING_LIBRARY_NAMES: {
                number: 10717,
                messageTemplate: "Invalid libraries for contract {contractName}: The names '{inputName}' and '{libName}' clash with each other, please use qualified names for both.",
                websiteTitle: "Conflicting library names",
                websiteDescription: `The library names clash with each other`,
            },
            INVALID_LIBRARY_NAME: {
                number: 10718,
                messageTemplate: "Invalid library name {libraryName} for contract {contractName}",
                websiteTitle: "Invalid library name",
                websiteDescription: `Invalid library name`,
            },
            LIBRARY_NOT_NEEDED: {
                number: 10719,
                messageTemplate: "Invalid library {libraryName} for contract {contractName}: this library is not needed by this contract.",
            ...
            ACCOUNT_INDEX_TOO_HIGH: {
                number: 10723,
                messageTemplate: "Requested account index '{accountIndex}' is greater than the total number of available accounts '{accountsLength}'",
            ...
            MISSING_MODULE_PARAMETER: {
                number: 10725,
                messageTemplate: "Module parameter '{name}' requires a value but was given none",
        ...
        STATUS: {
            UNINITIALIZED_DEPLOYMENT: {
                number: 10800,
                messageTemplate: "Cannot get status for nonexistant deployment at {deploymentDir}",
                websiteTitle: "Uninitialized deployment",
        ...
        DEPLOY: {
            ...
            ALREADY_IN_PROGRESS: {
                number: 10901,
                messageTemplate: "Another instance of `IgnitionHelper.deploy()` is already in use. Please wait for the previous deployment to finish.",
                websiteTitle: "Deployment already in progress",
                websiteDescription: "Another instance of `IgnitionHelper.deploy()` is already in use. Please wait for the previous deployment to finish.",
            },
        },
        VERIFY: {
            UNINITIALIZED_DEPLOYMENT: {
                number: 11000,
                messageTemplate: "Cannot verify contracts for nonexistant deployment at {deploymentDir}",
                websiteTitle: "Uninitialized deployment",
                websiteDescription: `Cannot verify contracts for nonexistant deployment`,
            },
            NO_CONTRACTS_DEPLOYED: {
                number: 11001,
                messageTemplate: "Cannot verify deployment {deploymentDir} as no contracts were deployed",
                websiteTitle: "No contracts deployed",
                websiteDescription: `Cannot verify deployment as no contracts were deployed`,
            },
            UNSUPPORTED_CHAIN: {
                number: 11002,
                messageTemplate: "Verification not natively supported for chainId {chainId}. Please use a custom chain configuration to add support.",
        ...
        STRATEGIES: {
            UNKNOWN_STRATEGY: {
                ...
                websiteTitle: "Invalid strategy name, must be either 'basic' or 'create2'",
                websiteDescription: "Invalid strategy, must be either 'basic' or 'create2'",
            },
            MISSING_CONFIG: {
                number: 11101,
                messageTemplate: "No strategy config passed for strategy '{strategyName}'",
                websiteTitle: "Missing strategy config",
                websiteDescription: `No strategy config passed for strategy`,
            },
            MISSING_CONFIG_PARAM: {
                number: 11102,
                messageTemplate: "Missing required strategy configuration parameter '{requiredParam}' for the strategy '{strategyName}'",
            ...
            INVALID_CONFIG_PARAM: {
                number: 11103,
                messageTemplate: "Strategy configuration parameter '{paramName}' for the strategy '{strategyName}' is invalid: {reason}",
        ...
        LIST_TRANSACTIONS: {
            UNINITIALIZED_DEPLOYMENT: {
                number: 11200,
                messageTemplate: "Cannot list transactions for nonexistant deployment at {deploymentDir}",
                websiteTitle: "Uninitialized deployment",
        ...
        TRACK_TRANSACTIONS: {
            ...
            UNINITIALIZED_DEPLOYMENT: {
                number: 11301,
                messageTemplate: "Cannot track transaction for nonexistant deployment at {deploymentDir}",
                websiteTitle: "Uninitialized deployment",
    ...
    HARDHAT_ETHERS: {
        GENERAL: {
            ...
            INVALID_ARTIFACT_FOR_FACTORY: {
                number: 20006,
                messageTemplate: "You are trying to create a contract factory from an artifact, but you have not passed a valid artifact parameter.",
            ...
            INVALID_ABSTRACT_CONTRACT_FOR_FACTORY: {
                ...
                websiteDescription: "Invalid abstract contract for contract factory creation",
            },
            ...
            ACCOUNTS_OF_TYPE_REMOTE: {
                number: 20014,
                messageTemplate: "Tried to obtain a private key, but the network is configured to use remote accounts.",
            ...
            NO_PRIVATE_KEY_FOR_ADDRESS: {
                ...
                websiteDescription: "The private key for the address could not be found. Please double check your private keys and try again.",
            },
        },
    },
    HARDHAT_MOCHA: {
        GENERAL: {
            TEST_TASK_ESM_TESTS_RUN_TWICE: {
                ...
                websiteDescription: 'You have run your tests twice programmatically and your project is an ESM project (you have `"type": "module"` in your `package.json`, or some of your files have the `.mjs` extension). This is not supported by Mocha yet (https://github.com/mochajs/mocha/issues/2706).',
            },
            GREP_EXCLUDE_INCOMPATIBLE_OPTION: {
                ...
                websiteDescription: "--grep-exclude is applied by merging it with --grep into Mocha's single name filter, so it cannot be combined with the `fgrep` or `invert` Mocha config options. Remove the conflicting option from your config, or express your filter using --grep and --grep-exclude only.",
            },
            INVALID_GREP_EXCLUDE_COMBINATION: {
                ...
                websiteDescription: "--grep and --grep-exclude are merged into a single regular expression. The combination was not valid, which usually happens when both patterns define a capture group with the same name. Rename or remove the duplicated group.",
            },
            ...
            GREP_INCOMPATIBLE_OPTION: {
                ...
                websiteDescription: "--grep and the `fgrep` Mocha config option are competing name filters, and Mocha applies only one of them; its own CLI rejects the pair as mutually exclusive. Remove `fgrep` from your config, or run without --grep.",
            },
        },
    },
    HARDHAT_VIEM: {
...
You can find a list of supported networks here: https://github.com/wevm/viem/blob/main/src/chains/index.ts`,
            ...
            UNSUPPORTED_DEVELOPMENT_NETWORK: {
                number: 40001,
                messageTemplate: "Unsupported development network detected. Hardhat and Anvil are the only supported networks.",
...
Please check Hardhat's output for more details.`,
            ...
            DEPLOY_CONTRACT_ERROR: {
                ...
                websiteDescription: "The deployment transaction was mined but its receipt doesn't contain a contract address.",
            },
        },
    },
    HARDHAT_KEYSTORE: {
        GENERAL: {
            INVALID_PASSWORD_OR_CORRUPTED_KEYSTORE: {
                ...
                websiteDescription: "The password you provided is incorrect or the keystore file is corrupted.",
            },
    ...
    NETWORK_HELPERS: {
        GENERAL: {
            ...
            BLOCK_NUMBER_SMALLER_THAN_CURRENT: {
                ...
                websiteDescription: "The block number is smaller than the current block number",
            },
            EVM_SNAPSHOT_VALUE_NOT_A_STRING: {
                ...
                websiteDescription: "The value returned by evm_snapshot should be a string",
            },
            EVM_REVERT_VALUE_NOT_A_BOOLEAN: {
                ...
                websiteDescription: "The value returned by evm_revert should be a boolean",
            },
            INVALID_SNAPSHOT: {
                number: 60009,
...
This might be caused by using hardhat_reset and loadFixture calls in a testcase.`,
            ...
            CAN_ONLY_BE_USED_WITH_HARDHAT_NETWORK: {
                ...
                websiteTitle: "Hardhat network helpers can only be used with the Hardhat Network",
                websiteDescription: "Hardhat network helpers can only be used with the Hardhat Network",
            },
            CAN_ONLY_BE_USED_WITH_HARDHAT_NETWORK_VERSIONED: {
                ...
                websiteTitle: "Hardhat network helpers can only be used with the Hardhat Network - version info",
                websiteDescription: "Hardhat network helpers can only be used with the Hardhat Network",
            },
        },
    },
    CHAI_MATCHERS: {
        GENERAL: {
            ...
            EXPECT_STRING_OR_REGEX_AS_REVERT_REASON: {
                number: 70006,
                messageTemplate: "Expected the revert reason to be a string or a regular expression",
                websiteTitle: "Expected the revert reason to be a string or a regular expression",
                websiteDescription: "Expected the revert reason to be a string or a regular expression",
            },
            FIRST_ARGUMENT_MUST_BE_A_CONTRACT: {
                number: 70007,
                messageTemplate: "The first argument of .revertedWithCustomError must be the contract that defines the custom error",
            ...
            CONTRACT_DOES_NOT_HAVE_CUSTOM_ERROR: {
                ...
                websiteTitle: "Contract doesn't have a custom error with the specified name",
                websiteDescription: "Contract doesn't have a custom error with the specified name",
            },
            REVERT_INVALID_ARGUMENTS_LENGTH: {
                number: 70010,
                messageTemplate: "The .revertedWithCustomError matcher expects two arguments: the contract and the custom error name. Arguments should be asserted with the .withArgs helper.",
                websiteTitle: "Invalid arguments length for the .revertedWithCustomError matcher",
                websiteDescription: "Invalid arguments length for the .revertedWithCustomError matcher",
            },
            WITH_ARGS_FORBIDDEN: {
                number: 70011,
                messageTemplate: "[.withArgs] should never happen, please submit an issue to the Hardhat repository",
                websiteTitle: "[.withArgs] should never happen, please submit an issue to the Hardhat repository",
                websiteDescription: "[.withArgs] should never happen, please submit an issue to the Hardhat repository",
            },
            INDEXED_EVENT_FORBIDDEN: {
                number: 70012,
                messageTemplate: "Should not get an indexed event when the assertion type is not event. Please open an issue about this.",
                websiteTitle: "Should not get an indexed event when the assertion type is not event",
                websiteDescription: "Should not get an indexed event when the assertion type is not event",
            },
            PANIC_CODE_EXPECTED: {
                number: 70013,
                ...
                websiteDescription: "Expected the given panic code to be a number-like value",
            },
            ACCOUNTS_NUMBER_DIFFERENT_FROM_BALANCE_CHANGES: {
                ...
                websiteTitle: "The number of accounts is different than the number of expected balance changes",
                websiteDescription: "The number of accounts is different than the number of expected balance changes",
            },
            ...
            EMIT_EXPECTS_TWO_ARGUMENTS: {
                number: 70019,
                messageTemplate: "The .emit matcher expects two arguments: the contract and the event name. Arguments should be asserted with the .withArgs helper.",
            ...
            WITH_ARGS_WRONG_COMBINATION: {
                number: 70022,
                messageTemplate: "withArgs can only be used in combination with a previous .emit or .revertedWithCustomError assertion",
                websiteTitle: "withArgs can only be used in combination with a previous .emit or .revertedWithCustomError assertion",
                websiteDescription: "withArgs can only be used in combination with a previous .emit or .revertedWithCustomError assertion",
            },
            WITH_ARGS_COMBINED_WITH_INCOMPATIBLE_ASSERTIONS: {
                number: 70023,
                messageTemplate: "withArgs called with both .emit and .revertedWithCustomError, but these assertions cannot be combined",
                websiteTitle: "withArgs called with both .emit and .revertedWithCustomError, but these assertions cannot be combined",
                websiteDescription: "withArgs called with both .emit and .revertedWithCustomError, but these assertions cannot be combined",
            },
            DEPRECATED_REVERTED_MATCHER: {
                number: 70024,
                messageTemplate: "The .reverted matcher has been deprecated. Use .revert(ethers) instead.",
                websiteTitle: "Deprecated `reverted` matcher",
                websiteDescription: "The `.reverted` matcher was deprecated and you should use `.revert(ethers)` instead.",
            },
        },
    },
    HARDHAT_VERIFY: {
...
Please check the returned message for details.`,
            ...
            CONTRACT_VERIFICATION_STATUS_POLLING_FAILED: {
                ...
                websiteDescription: "The block explorer returned a failure status when checking the verification status. Verification may still succeed; please check manually.",
            },
...
Another common cause is missing or incorrect library addresses. If your contract uses libraries whose addresses cannot be detected automatically, please make sure you provide the correct address for each undetectable library.`,
            ...
            BLOCK_EXPLORER_NOT_CONFIGURED: {
                number: 80027,
                messageTemplate: "No {verificationProvider} block explorer is configured for the {chainId} chain in the chain descriptors.",
...
To resolve this, set a valid non-empty API key in your Hardhat config, then try again.`,
        ...
        VALIDATION: {
            ...
            MUTUALLY_EXCLUSIVE_CONSTRUCTOR_ARGS: {
                number: 80101,
                messageTemplate: "The parameters constructorArgs and constructorArgsPath are mutually exclusive.",
                websiteTitle: "Mutually exclusive constructor arguments",
                websiteDescription: "The parameters constructorArgs and constructorArgsPath are mutually exclusive. Please provide only one of them.",
            },
...
`,
            ...
            MODULE_NOT_FOUND: {
                ...
                websiteDescription: "The specified module could not be found. Please check the path and try again.",
            },
            MODULE_SYNTAX_ERROR: {
                number: 80104,
                messageTemplate: `The module specified by "{modulePath}" has a syntax error: {errorMessage}`,
                websiteTitle: "Module syntax error",
                websiteDescription: "The specified module has a syntax error. Please fix the error and try again.",
            },
...
\`\`\``,
            ...
            INVALID_VERIFICATION_PROVIDER: {
                ...
                websiteDescription: "The specified verification provider is not supported. Please use one of the supported providers.",
            },
        },
    },
    HARDHAT_LEDGER: {
