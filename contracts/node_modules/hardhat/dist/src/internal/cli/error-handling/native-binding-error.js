 ...
 */
const PLATFORM_SUFFIX_REGEX = /-(?:android|darwin|freebsd|linux|win32)-(?:arm|arm64|ia32|x64|riscv64|ppc64|s390x)(?:-(?:gnu|musl|msvc|eabi|gnueabihf))?$/;
/**
 ...
 * `node_modules`.
 */
export function detectNativeBindingFailure(error) {
...
//# sourceMappingURL=native-binding-error.js.map