...
(function (ErrorCategory) {
    ErrorCategory["HARDHAT"] = "HARDHAT";
    ErrorCategory["PLUGIN"] = "PLUGIN";
    ErrorCategory["COMMUNITY_PLUGIN"] = "COMMUNITY_PLUGIN";
    ErrorCategory["HH2_TO_HH3_MIGRATION"] = "HH2_TO_HH3_MIGRATION";
    ErrorCategory["CJS_TO_ESM_MIGRATION"] = "CJS_TO_ESM_MIGRATION";
 ...
 */
export async function printErrorMessages(error, shouldShowStackTraces = false, print = console.error) {
    const { category, categorizedError } = await getErrorWithCategory(error);
    let formattedErrorMessage;
    let showMoreInfoMessage;
    let postErrorStackTraceMessage;
    switch (category) {
        ...
        case ErrorCategory.HH2_TO_HH3_MIGRATION:
            formattedErrorMessage = styleText(["red", "bold"], `Hardhat 3 migration error:`);
...
async function getErrorWithCategory(error) {
    ...
    if (nativeBindingFailure !== undefined) {
        return {
            category: ErrorCategory.HARDHAT,
            categorizedError: new HardhatError(HardhatError.ERRORS.CORE.GENERAL.NATIVE_BINDING_LOAD_FAILED, {
