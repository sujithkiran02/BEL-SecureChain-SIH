...
export declare function compareSnapshotCheatcodes(previousSnapshotsMap: SnapshotCheatcodesMap, currentSnapshotsMap: SnapshotCheatcodesWithMetadataMap, tolerance: number): SnapshotCheatcodesComparison;
export declare function checkSnapshotCheatcodes(basePath: string, suiteResults: SuiteResult[], tolerance: number): Promise<SnapshotCheatcodesCheckResult>;
export declare function logSnapshotCheatcodesSection(result: SnapshotCheatcodesCheckResult, logger?: typeof console.log, isFiltered?: boolean): void;
