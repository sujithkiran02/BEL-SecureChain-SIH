...
const hardhatPlugin = definePlugin({
    ...
    tasks: [
        overrideTask("test")
            ...
            .addFlag({
            name: "snapshotCheck",
            description: "Check the snapshots match the stored values (Solidity tests only)",
        })
            .addOption({
            name: "tolerance",
            description: "Allowed drift percentage for --snapshot-check (Solidity tests only)",
