 ...
 */
export declare function makeGroupKey(contractFqn: string, proxyChain: string[]): string;
/**
 ...
 */
export declare function getProxyLabel(proxyChain: string[]): string | undefined;
/**
 ...
 * JSON object keys.
 */
export declare function getDisplayKey(userFqn: string, proxyChain: string[]): string;
 ...
 */
export declare function isWithinTolerance(expected: number, actual: number, tolerance: number): boolean;
