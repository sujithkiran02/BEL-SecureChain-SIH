...
export declare function compareFunctionGasSnapshots(previousSnapshots: FunctionGasSnapshot[], currentSnapshots: FunctionGasSnapshotWithMetadata[], tolerance: number): FunctionGasSnapshotComparison;
...
export declare function checkFunctionGasSnapshots(basePath: string, suiteResults: SuiteResult[], tolerance: number): Promise<FunctionGasSnapshotCheckResult>;
export declare function logFunctionGasSnapshotsSection(result: FunctionGasSnapshotCheckResult, logger?: typeof console.log, isFiltered?: boolean): void;
