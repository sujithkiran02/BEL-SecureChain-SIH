...
import type { Compiler, CompilerInput, CompilerOutput, ResolvedBuildOptions } from "../../../types/solidity.js";
...
declare module "../../../types/hooks.js" {
    ...
    interface SolidityHooks {
         ...
         * @deprecated This hook will soon be removed.
         */
        readNpmPackageRemappings: (context: HookContext, packageName: string, packageVersion: string, packagePath: string, next: (nextContext: HookContext, nextPackageName: string, nextPackageVersion: string, nextPackagePath: string) => Promise<Array<{
            remappings: string[];
            source: string;
        }>>) => Promise<Array<{
            remappings: string[];
         ...
         * provide.
         */
        processArtifactsAfterSuccessfulBuild(context: HookContext, artifactPaths: readonly string[], buildRootFilePaths: readonly string[], buildOptions: Readonly<ResolvedBuildOptions>): Promise<void>;
        /**
         ...
         */
        getCompilationJobErrors(context: HookContext, compilationJob: Readonly<CompilationJob>, compilerOutput: Readonly<CompilerOutput>, next: (nextContext: HookContext, nextCompilationJob: Readonly<CompilationJob>, nextCompilerOutput: Readonly<CompilerOutput>) => Promise<CompilerOutputError[]>): Promise<CompilerOutputError[]>;
    }
}
