export function formatArtifactId(artifactId, sourceNameToUserSourceName) {
    const sourceName = sourceNameToUserSourceName.get(artifactId.source) ?? artifactId.source;
 ...
 */
export function formatInlineConfigErrors(errors, sourceNameToUserSourceName) {
    return errors
        .map((error) => {
        const sourceName = sourceNameToUserSourceName.get(error.sourceName) ?? error.sourceName;
...
function formatInlineConfigDirectiveProblem(problem) {
    switch (problem.kind) {
...
function formatInlineConfigSourceProblem(problem) {
    switch (problem.kind) {
